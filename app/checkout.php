...
<section class="wide-btn-wrapper" style="position: relative; ">
    ...
    <a href="#" class="primary-btn--checkout-btn--active apple-pay-btn center" style="background-color: var(--black); color: var(--white);" onclick="openApplePay(orderTotal)"> Buy with
...
<div id="applePayModal" class="apple-pay-modal hidden">
  <div class="apple-pay-container">
    ...
    <div class="apple-pay-header">
      ...
      <button id="closeApplePay" class="close-btn">✕</button>
    </div>

    <div class="card-box">
      <div class="card-info">
        <div class="card-name">Discover</div>
        <div class="card-meta">Kayla Liu •••• 1234</div>
      </div>
    ...
    <div class="payment-info">
      <div class="merchant">Pay Pete's Little Lunch Box</div>
      <div class="amount" id="applePayAmount">$0.00</div>
    </div>

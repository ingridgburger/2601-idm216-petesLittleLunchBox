...
<body>
    ...
    <div class="case-study-container">
        ...
        MAAYAN CHASHPER | ROLE: PROJECT MANAGER & DATA ARCHITECT | TIME: 10 WEEKS <br>
        TOOLS: FIGMA, HTML, CSS, MICROSOFT TEAMS, GITHUB, GOOGLE FORMS, ZOOM
        </p>
        ...
        <section class="case-section">
            ...
            <p class="case-text">My primary role was Project Manager, where I coordinated workflows, managed tasks, and ensured the team stayed organized and on schedule. My secondary role was Data Architect, where I helped organize database information and prepare image assets used in the data tables.</p>
            ...
            <!-- Change this paragraph so it's specific to you -->
            <p class="case-text">To support collaboration, we used Microsoft Teams for communication and task management and GitHub for version control. I organized our Teams workspace, maintained the Planner board, and ensured project links, files, and documentation remained updated.</p>
